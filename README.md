...
- **Anotacion Transactional** El servicio superior, ejecutarOperacion, esta implemetando con lógica transacional desde que llamas a la API hasta que acabas de guardar la información en la BBDD, para poder deshacer los cambios en caso de error.
...
- **Test** Se han añadido dos clases de tipo Test, que implementan logica de SpringBootTest y JUnit para verificar el conrrecto funcionamiento del controlador y los microservicios asociados a la llamada de la API y la persistencia en BBDD.
- **BBDD Schema**
